    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img style={{borderRadius: '50%'}} id="profileImage" className="w-full" src="./images/logos/profile.jpg" alt="Herbert Santos Profile " />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Herbert Santos</span> ,</div>
            ...
            <ul className=" leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a developer with more than 11 years of experience.</li>
    ...
    return (
        <>
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list">
                ...
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div> My areas of expertise are <strong className="text-ubt-gedit-orange">front-end development, Angular, React.js & javascript!</strong></div>
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
            ...
            <div className="w-full md:w-10/12 flex justify-center items-start font-bold text-center">
                <div className="px-2 w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className="m-1" src="https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white" alt="hssant chsarp" />
                ...
                <div className="px-2 flex flex-wrap items-start w-1/2">
                    <div className="flex flex-wrap justify-center items-start w-full mt-2">
                        ...
                        <img className=" m-1" src="https://img.shields.io/badge/angular-%23DD0031.svg?style=for-the-badge&logo=angular&logoColor=white" alt="hssant angular" />
                        <img className=" m-1" src="https://img.shields.io/badge/.NET-5C2D91?style=for-the-badge&logo=.net&logoColor=white" alt="hssant angular" />
    ...
    const project_list = [
        {
            name: "HeroApp",
            date: "Mar 2021",
            link: "https://play.google.com/store/apps/details?id=com.heroappcliente",
            description: [
                "A 'uber-like' mobile platform based in Brazil for hire a professional to execute house tasks like clean or fixes",
            ],
            domains: ["react-native", "firestore"]
        },
        {
            name: "Notifeye Legal",
            date: "Jan 2021",
            link: "https://apps.apple.com/us/app/notifeye-legal/id1473163946",
            description: [
                "A mobile app for hire legal services and follow up your orders.",
            ],
            domains: ["react-native", "firestore", "javascript", "firebase auth"]
        },
        {
            name: "Ecoletas",
            date: "Dec 2020",
            link: "https://play.google.com/store/apps/details?id=com.horadolixo.app.horadolixo&hl=pt_BR&gl=US",
            description: [
                "Ionic Application to visualize in real time the trucks that collect the garbage in street.",
            ],
            domains: ["ionic", "javascript"]
        },
        {
            name: "Unimaq Integra",
            date: "Nov 2020",
            link: "https://apps.apple.com/br/app/unimaq-integra/id1555710736",
            description: [
                "A corporate mobile app to share news and informations with customers and employees",
            ],
            domains: ["javascript", "html5", "sass", "firebase", "ionic"]
        },
        {
            name: "Seu Vale",
            date: "Sep 2020",
            link: "https://apps.apple.com/br/app/seuvale/id1525923822",
            description: [
                "A webapp to administrate benefits and payments for employees.",
            ],
            domains: ["angular",  "javascript"]
        },
        {
            ...
            description: [
                "Developed a screenscrapper api to automate interactions between app and legacy systems of bank",
            ],
            domains: ["java",  "android"]
        }
    ];
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/herbert-santos-resume.pdf" title="herbert santos resume" frameBorder="0"></iframe>
    )
}